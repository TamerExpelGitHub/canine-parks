...
import { setupRenderingTest } from 'canine-parks/tests/helpers';
import { render, find } from '@ember/test-helpers';
import { hbs } from 'ember-cli-htmlbars';
import ENV from 'canine-parks/config/environment';
...
module('Integration | Component | map', function (hooks) {
  ...
  test('it updates the `src` attribut when the arguments change', async function (assert) {
    this.setProperties({
      lat: 37.7749,
      lng: -122.4194,
      zoom: 10,
